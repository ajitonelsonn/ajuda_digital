        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Currently we have 4 available models with datasets collected from government websites and official documents. 
              More models are being developed with government support.
            </p>

            {/* Challenges Section */}
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-8 border border-blue-200 max-w-4xl mx-auto">
              <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Current Challenges & Context</h3>
              <div className="space-y-4 text-left">
                <div className="bg-white rounded-lg p-6 shadow-sm">
                  <h4 className="font-semibold text-gray-800 mb-3">🏛️ Limited Government Data Access</h4>
                  <p className="text-gray-700">
                    Access to government data is challenging and very difficult to obtain. We're working with limited resources 
                    and facing bureaucratic barriers in accessing comprehensive official datasets.
                  </p>
                </div>
                
                <div className="bg-white rounded-lg p-6 shadow-sm">
                  <h4 className="font-semibold text-gray-800 mb-3">⏰ Time Constraints</h4>
                  <p className="text-gray-700">
                    Due to time limitations, we've had to collect data from various sources including website screenshots, 
                    tech pictures on boards, and whatever government documents we could download publicly.
                  </p>
                </div>
                
                <div className="bg-white rounded-lg p-6 shadow-sm">
                  <h4 className="font-semibold text-gray-800 mb-3">🚀 Hackathon Initiative Impact</h4>
                  <p className="text-gray-700">
                    We believe this hackathon and our initiative will demonstrate the value of our product to the government, 
                    potentially leading to official support and better access to comprehensive datasets in the future.
                  </p>
                </div>

                <div className="bg-white rounded-lg p-6 shadow-sm">
                  <h4 className="font-semibold text-gray-800 mb-3">📊 Current Data Sources</h4>
                  <p className="text-gray-700">
                    Our current datasets come from a mix of sources: publicly available government documents, 
                    official PDFs from government websites, process documentation, and legal texts that we've been able to access.
                  </p>
                </div>
              </div>
            </div>
          ...
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Available Models</h2>
            <div className="grid gap-8 md:grid-cols-2">
              {availableModels.map((model) => (
                <div key={model.id} className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-gray-700 leading-relaxed max-w-2xl mx-auto mb-8">
                The following models are currently in development and will be available soon:
              </p>
            </div>

            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 max-w-4xl mx-auto">
              {upcomingModels.map((model, index) => (
                <div key={index} className="bg-yellow-100 rounded-lg p-4 text-center">
